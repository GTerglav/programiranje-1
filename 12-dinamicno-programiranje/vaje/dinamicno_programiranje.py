...
#[*----------------------------------------------------------------------------*)
#
#rec alternating_towers n =
#  stevilo_rdecih = Array.make n+3 0 in
#  stevilo_modrih = Array.make n+3 0 in
#  rec modri l =
...
#
#test_tree = Node( Node(leaf 0, 2, leaf 13), 5, Node(leaf 9, 7, leaf 4))
#
##----------------------------------------------------------------------------*]
## Cena sprehoda po drevesu je vsota vrednosti v vseh obiskanih vozliščih.
